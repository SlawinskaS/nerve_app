...
public class AddNewPills extends Header implements com.wdullaer.materialdatetimepicker.time.TimePickerDialog.OnTimeSetListener, com.wdullaer.materialdatetimepicker.date.DatePickerDialog.OnDateSetListener{
    ...
    Button HidePicker;
    Button ShowPicker;
    EditText DoseOfMedicine;
    EditText frequencyMedicine;
    EditText AddFood;
    String[] dania;
    String[] typyJedzenia;
    String meal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        frequencyMedicine = (EditText)findViewById(R.id.frequencyMedicine);
        DoseOfMedicine= (EditText)findViewById(R.id.DoseOfMedicine);
...
//        timePicker = (TimePicker) findViewById(R.id.timePickerFood);
        ...
        meal = sharedPreferences.getString(("Medicine").toString(),null);
        if (meal!=null){
...
//
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                if(!(spinner.getSelectedItem().equals("choose your Medicine"))){
...
//        Log.e("Zapinane danie" , mealZapisane.toString());
    ...
    private void addToCalendarMeal() {
        ...
        seizureAdder.addToArray("Medicine_" + mealDate, timeOfFood + ";" +
                spinner.getSelectedItem() + ";" +
                frequencyMedicine.getText().toString()
                +";"+DoseOfMedicine.getText().toString(), this);
        seizureAdder.addToArray("Medicine", mealDate, this);
        SharedPreferences sharedPreferences = getSharedPreferences("Nerve", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        editor.putString(("nameOfMedicine").toString(), spinner.getSelectedItem().toString() );
        editor.putString(("doseOfMedicine").toString(), frequencyMedicine.getText().toString()  );
        editor.putString(("frequencyOfMedicine").toString(),DoseOfMedicine.getText().toString()  );
        editor.apply();
    ...
    public void addNewMeal(View view){
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("Nerve", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharedPreferences.edit();
        String meal = sharedPreferences.getString(("Medicine").toString(),null);
//        Log.e("asd",meal);
        String[] dania2;
        if (meal==null)
        {
            editor.putString(("Medicine").toString(),newMeal);


        }
        else
        {
            editor.putString(("Medicine").toString(),meal + "\n" + newMeal);
        }
        editor.apply();
...
//        Log.e("test","test3");
    ...
    public void onBackPressed()
    {
        ...
        Intent intentMain = new Intent(AddNewPills.this ,
                MainActivity.class);
        AddNewPills.this.startActivity(intentMain);
